    ...
    <StyledDiv>
      <section className="container-fluid">
        ...
        <div className="row pt-5">
          {/* Left column */}
          <div className="col-lg-8 m-auto banner-image-box">
            <img src={testImg} alt="banner" className="banner-image" />
          </div>

          {/* Right column */}
          <div className="col-lg-3 m-auto">
            <h2 className="banner-header">Welcome to Cooplag 2020.</h2>
            <p>Exploring Digitalization in Oil and Gas</p>
            <div className="row">
              <div className="col-lg-4">
                <Button label="Sign Up" className="button" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12 partners mt-5">
            <h2 className="partners-caption">Sponsors & Partners</h2>
