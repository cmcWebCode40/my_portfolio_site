...
export default function RequiredFiles(props) {
  ...
  return (
    <StyledDiv>
      <div className="container credential-main-body">
        <div className="row">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="right-side m-auto">
            ...
            <div id="credential-form">
              ...
              <div>
                ...
                {errors.business_city && (
                  <p className="error-para">Plaese input a valid Number (eg: +1238123456709)</p>
                )}
              </div>
              <div>
                <input
              ...
              <div>
                ...
                />
                {errors.business_city && (
                  <p className="error-para">Plaese input duration as an interger</p>
                )}
              </div>
              <div>
                <input
