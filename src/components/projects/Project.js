...
const Project = () => {
	const [items] = useState([
		{
			id: Math.random(),
			title: 'FoodCrowdy (No 1 Nigeria Food Store).',
			description: `
			FoodCrowdy is guided by the passion for innovation, providing real solutions to real problems, customer satisfaction, commitment to operational excellence and long-term thinking.
			 Frontend Stack: React.js, Material-UI, Redux-toolkit`,
			img: 'https://res.cloudinary.com/cmcwebcode/image/upload/v1618781495/food_port_ojtlai.jpg',
			source: 'https://github.com/cmcWebCode40',
			website: 'https://foodcrowdy.com/'
		},
		{
			id: Math.random(),
			title: ' Global Courier Logistics',
			description: `Global Courier Logistics has forged long term (wholesale) relationships / partnerships with all the major airlines, express courier integrators, worldwide freighter networks,
			Frontend-Stack: React.js, Bootstrap, sass. `,
			img: 'https://res.cloudinary.com/cmcwebcode/image/upload/v1618781502/global_port_prsg0e.jpg',
			source: 'https://github.com/cmcWebCode40',
			website: 'https://globalcourierlogistics.online/'
		},
		{
			id: Math.random(),
	...
	This app was built with HTML, CSS / SASS & REACTjs`,
			...
			website: 'https://editorialcds.herokuapp.com/'
		},
		{
			id: Math.random(),
		...
		},
		{
			...
			website: 'https://chinweikemichael.netlify.app/'
		},
		{
			id: Math.random(),
			title: 'La More Collections Website',
