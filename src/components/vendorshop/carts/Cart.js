              ...
              <div key={Math.random(0, 300)} className="d-flex justify-content-between my-4">
                <div className="">
                  <div className="d-flex">
                    <div>
                      <img height="50" src="https://images.unsplash.com/photo-1432958576632-8a39f6b97dc7?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ&s=6ecedc1e639d8a4b77aa8e85f4962f03" alt="cart" />
                    </div>
                ...
                <div className="">
                  ...
                  <button type="button" className="btn btn-primary px-3 btn-sm">
                    <FontAwesomeIcon icon={['fa', 'caret-left']} size="1x" className="icon shopping-cart" />
                  </button>
                  <button type="button" className="btn font-weight-bold bg-light ">
                    1
                  </button>
                  <button type="button" className="btn btn-primary px-3 btn-sm">
                    <FontAwesomeIcon icon={['fa', 'caret-right']} size="1x" className="icon shopping-cart" />
                  </button>
                  <div className="mt-3">
